...
public class ClienteChat extends JFrame implements ActionListener {
	...
	static SSLSocketFactory sslFactory = (SSLSocketFactory)
			SSLSocketFactory.getDefault();
	static SSLSocket cliSocket;
	//Socket socket;
	...
	public ClienteChat(SSLSocket cliSocket, String nombre) {
...
//lo reenvía a todos los clientes conectados
		try {
			fentrada = new DataInputStream(cliSocket.getInputStream());
			fsalida = new DataOutputStream(cliSocket.getOutputStream());
...
//lanzando su ejecución (ejecutar()).
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("javax.net.ssl.trustStorePassword", "Studium2022;");
		//int puerto = 44444;
		...
		if (!nombre.trim().equals("")) {
			ClienteChat cliente = new ClienteChat(cliSocket, nombre);
